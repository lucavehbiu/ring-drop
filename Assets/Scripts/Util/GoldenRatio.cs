/// <summary>
/// Golden ratio (φ = 1.618) design system constants.
/// Every spacing, font size, and layout proportion derives from φ.
/// </summary>
public static class GoldenRatio
{
    public const float PHI = 1.6180339887f;
    public const float PHI_INV = 0.6180339887f; // 1/φ
    ...
    public const float XXXL = 89f; // 55×φ
    ...
    // Layout proportions
    public const float MAJOR = 0.618f;  // 1/φ — dominant section
    public const float MINOR = 0.382f;  // 1 - 1/φ — secondary section
