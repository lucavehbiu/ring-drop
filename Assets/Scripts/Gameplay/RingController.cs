...
public class RingController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        // Wind
        float windBase = Mathf.Sin(Time.time + GameManager.Instance.Level) * _wind;
        ...
        if (pos.y < -0.3f)
            GameManager.Instance.OnFail("ground");
        ...
        if (pos.z <= _targetZ)
        {
            ...
            GameManager.Instance.OnRingReachedStick(inAlignment && inHeight);
        }
